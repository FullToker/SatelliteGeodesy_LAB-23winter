...
\begin{figure}
  \centering
  {
  \includegraphics[width=6cm]{../result/KIRU/KIRU_4.jpg}}
  \hspace{4pt}    
  {
  \includegraphics[width=6cm]{../result/KIRU/KIRU_4(zoom_up).jpg}}
  ...
  \begin{figure}
    \centering
    {
    \includegraphics[width=6cm]{../result/MORP/MORP_4.jpg}}
    \hspace{4pt}    
    {
    \includegraphics[width=6cm]{../result/MORP/MORP_4(zoom_up).jpg}}

...
fid=fopen('KIRU_ig1.xyz');%Read the file
...
ref=[2251420.796,862817.223,5885476.71];%Read the Geocentric cartesian coordinates
...
%For the two sets of data specified by t1 and t2, construct design matrices A1 and A2 respectively.
...
vel_gps=[(para_u1(2)+para_u2(2))/2;(para_e1(2) ...
    +para_e2(2))/2;(para_n1(2)+para_n2(2))/2];%Calculate GPS speed
